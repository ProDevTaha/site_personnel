...
<main class="flex-shrink-0">
    ...
    <!-- resum  -->
    <div class="container px-5 my-5" id="myResume">
                            ...
                            <div class="row align-items-center gx-5">
                                <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                    <div class="bg-light p-4 rounded-4">
                                        <div class="text-primary fw-bolder mb-2">January 2022 - Currently</div>
                                        <div class="small fw-bolder">développeur full stack JAVA/ANGULAR</div>
                                    </div>
                                </div>
                                <div class="col-lg-8"><div>Conception, code, test, debug, maintain web applications ( The BMCE) using javaEE ,C# , Javascript, SpringBoot, XAML , XML , Angular.js </div></div>
                            </div>
                        </div>
                    </div>
                    <div class="card shadow border-0 rounded-4 mb-5">
                        <div class="card-body p-5">
                            <div class="row align-items-center gx-5">
                                ...
                                <div class="col-lg-8"><div>Élaboration d'une application qui gère la partie comptabilité de l'entreprise , développée en utilisant les technologies suivantes : Laravel, ReactJs, MySQL, ainsi que les outils Jira, Git et GitHub.</div></div>
                            </div>
                        </div>
                    </div>
                    <!-- Experience Card 2-->
                    <div class="card shadow border-0 rounded-4 mb-5">
                        <div class="card-body p-5">
                            <div class="row align-items-center gx-5">
                                <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                    <div class="bg-light p-4 rounded-4">
                                        <div class="text-primary fw-bolder mb-2">may 2020 – june 2022</div>
                                        <div class="small fw-bolder">FreeLancer web Developer</div>
                                        <div class="small text-muted">Fiverr</div>
                                    </div>
                                </div>
                                <div class="col-lg-8"><div>Design, code, test, debug, maintain web applications using PHP, Javascript,javaEE , Laravel, Tailwind CSS, React.js, Node.js</div></div>
                            </div>
                        </div>
                    </div>
                </section>
                            ...
                            <div class="row align-items-center gx-5">
                                <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                    <div class="bg-light p-2 rounded-4">
                                        <div class="text-secondary fw-bolder text-center mb-2">2020 - 2022</div>
                                        <div class="mb-2">
                                            <div class="small fw-bolder text-center">YouCode - UM6P </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-8"><div>Web and Mobile Development</div></div>
                            </div>
                        </div>
                    </div>
                    <!-- Education Card 2-->
                    <div class="card shadow border-0  rounded-4 mb-5">
                        <div class="card-body">
                            <div class="row align-items-center gx-5">
                                <div class="col text-center text-lg-start mb-4 mb-lg-0">
                                    <div class="bg-light p-2 rounded-4">
                                        <div class="text-secondary fw-bolder mb-2 text-center">2022 - 2023</div>
                                        <div class="mb-2">
                                            <div class="small fw-bolder text-center">university hassan 2</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-8"><div>Professional license in web development</div></div>
                            </div>
                        </div>
                    </div>
                </section>
